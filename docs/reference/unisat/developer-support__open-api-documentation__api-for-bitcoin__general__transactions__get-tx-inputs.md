<!--
UniSat docs — Get Tx Inputs
Source: https://docs.unisat.io/developer-support/open-api-documentation/api-for-bitcoin/general/transactions/get-tx-inputs.md
Retrieved: 2026-09-14
Mirrored for offline reference; the vendor is the source of truth.
-->

> For the complete documentation index, see [llms.txt](https://docs.unisat.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.unisat.io/developer-support/open-api-documentation/api-for-bitcoin/general/transactions/get-tx-inputs.md).

# Get Tx Inputs

{% openapi src="/files/r4o4wn8MaaisuPe8MEqf" path="/v1/indexer/tx/{txid}/ins" method="get" %}
