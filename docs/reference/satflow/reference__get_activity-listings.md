<!--
Satflow docs — Get listings activity data
Source: https://docs.satflow.com/reference/get_activity-listings.md
  ...
  "paths": {
    "/activity/listings": {
      "get": {
        ...
        "description": "Returns listings activity data with optional filtering and pagination",
        "parameters": [
          {
            "in": "query",
            "name": "collectionSlug",
        ...
        "responses": {
          "200": {
            "description": "Listings activity data retrieved successfully",
            "content": {
              "application/json": {
                "schema": {
