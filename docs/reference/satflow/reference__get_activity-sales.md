<!--
Satflow docs — Get sales activity data
Source: https://docs.satflow.com/reference/get_activity-sales.md
  ...
  "paths": {
    "/activity/sales": {
      "get": {
        ...
        "description": "Returns sales activity data with optional filtering and pagination",
        "parameters": [
          {
            "in": "query",
            "name": "collectionSlug",
        ...
        "responses": {
          "200": {
            "description": "Sales activity data retrieved successfully",
            "content": {
              "application/json": {
                "schema": {
