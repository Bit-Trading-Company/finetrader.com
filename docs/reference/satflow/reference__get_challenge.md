<!--
Satflow docs — Get challenge message for wallet verification
Source: https://docs.satflow.com/reference/get_challenge.md
  ...
  "paths": {
    "/challenge": {
      "get": {
        ...
        "description": "Returns a challenge message that needs to be signed by the wallet",
        "parameters": [
          {
            "in": "query",
            "name": "address",
