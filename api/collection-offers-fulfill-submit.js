// Vercel serverless function to proxy Magic Eden Collection Offers Fulfill Submit API
export default async function handler(req, res) {
  ...
  try {
    ...
    const baseUrl = 'https://api-mainnet.magiceden.us/v2/ord/btc/collection-offers/psbt/fulfill/submit';
    ...
    console.error('Collection offers fulfill submit proxy error:', error);
